...
# import keyboard #### insteasd of keyboard module i am using pyautogui module..
import cv2
import phonenumbers
...
if __name__ == '__main__':
    ...
    while True:
        ...
        #     webbrowser.Chrome.open("youtube.com")
            ...
            pyautogui.press("Alt + Home")
        elif "page up" in query:
            pyautogui.press("ctrl + Page Down")
        elif "page down" in query:
            pyautogui.press("ctrl + page up")
        elif "open incognito" in query:
            pyautogui.press("alt + ctrl + n")
        elif "downlaod" in query:
            pyautogui.press("ctrl + j")
        elif "open history" in query:
            pyautogui.press("ctrl + h")
        elif "forward a page" in query:
            pyautogui.press("alt + right arrow") 
        ...
        #     os.startfile(codePath)
            ...
            speak(location)
            webbrowser.get("Chrome").open("https://www.google.co.in/maps/place/"  + location)
        ...
        # NPPR9-FWDCX-D2C8J-H872K-2YT43
            ...
            os.startfile("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe")
            pyautogui.press("ctrl + k")
            pyautogui.press("backspace")

            pyautogui.typewrite("blackhat bird",0.2)
